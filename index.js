...
const keynya = "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"
...
const start = async () => {
    ...
    client.ev.on('messages.upsert', async (msg) => {
        try {
            ...
            if (ishalo) {
                await reply(`Hai, ada yang bisa Alqa bantu?`);
                ...
                await reply("Maaf, tolong kasih Alqa pertanyaan lebih detail & spesifik lagi :)");
    ...
    client.ws.on('CB:call', async call => {
        if (call.content[0].tag == 'offer') {
            ...
            const caption = `Maaf ALQA tidak dapat menerima panggilan :)`
